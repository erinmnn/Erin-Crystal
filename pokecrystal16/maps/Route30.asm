...
Route30_MapEvents:
	...
	object_event  6, 26, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 1, TrainerYoungsterJoey, EVENT_ROUTE_30_YOUNGSTER_JOEY
