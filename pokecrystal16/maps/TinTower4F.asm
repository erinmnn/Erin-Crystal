...
TinTower4F_MapEvents:
	...
	def_bg_events
	bg_event  9, 10, BGEVENT_ITEM, TinTower4FHiddenMaxPotion

	def_object_events
	object_event 11,  8, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 2, TrainerGruntF6, EVENT_TIN_TOWER_ROCKET_POPULATION
	object_event  3, 11, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerGruntF7, EVENT_TIN_TOWER_ROCKET_POPULATION
