...
VulpixEvosAttacks:
	dbbw EVOLVE_LEVEL, 19, NINETALES
	db 0 ; no more evolutions
	dbw 1, EMBER
	dbw 1, TAIL_WHIP
	dbw 7, QUICK_ATTACK
...
PoliwagEvosAttacks:
	dbbw EVOLVE_LEVEL, 21, POLIWHIRL
	db 0 ; no more evolutions
	dbw 1, WATER_GUN
	dbw 7, HYPNOSIS
	dbw 13, BUBBLEBEAM
...
ChanseyEvosAttacks:
	dbbw EVOLVE_ITEM, LUCKY_EGG, BLISSEY
	db 0 ; no more evolutions
	dbw 1, DOUBLESLAP
	dbw 13, SOFTBOILED
	dbw 23, MINIMIZE
