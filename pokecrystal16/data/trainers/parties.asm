...
MortyGroup:
	...
	dw MAROWAK
	db THICK_CLUB
	dw BONEMERANG, SHADOW_BALL, ROCK_SLIDE, FRUSTRAION
	db 49
	dw GENGAR
	db MIRACLEBERRY
	dw DESTINY_BOND, THUDNERBOLT, FIRE_PUNCH, ICE_PUNCH
	db -1 ; end
...
ScientistGroup:
	...
	dw TANGELA
	db QUICK_CLAW
	db ANCIENTPOWER, STUN_SPORE, WRAP, GIGA_DRAIN
	db 44
	dw PORYGON2
	db LEFTOVERS
...
GruntMGroup:
	...
	dw SANDSLASH
	db GOLD_BERRY
	dw EARTHQUAKE, FIG, ROCK_SLIDE, FURY_CUTTER
	db 44
	dw VENOMOTH
	db BRIGHTPOWDER
...
ExecutiveMGroup:
	...
	dw NIDOKING
	db KINGS_ROCK
	dw EARHTQUAKE, SLUDGE, SURF, ICE_BEAM
	db 46
	dw PERSIAN
	db SCOPE_LENS
