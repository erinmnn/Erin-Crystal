...
BugsyGroup:
	...
	dw HERACROSS
	db BERRY_JUICE
	dw VITAL_THROW, WING_ATTACK, ROCK_SLIDE, EARTHQUAKE
	db -1 ; end
...
BugCatcherGroup:
	...
	dw PINSIR
	db BERRY_JUICE
	dw VITAL_THROW, COUNTER, WING_ATTACK, MEGAHORN
	db 27
	dw FORRETRESS
	db FOCUS_BAND
	...
	dw SCYTHER
	db SHARP_BEAK
	dw WING_ATTACK, SCREECH, KARATE_CHOP, FURY_CUTTER
	db -1 ; end
...
SageGroup:
	...
	dw PINECO
	db FOCUS_BAND
	dw SPIKES, LIGHT_SCREEN, REFLECT, PIN_MISSILE
	db 13
	dw BULBASAUR
	db BERRY_JUICE
...
PokefanMGroup:
	...
	dw CLEFAIRY
	db PINK_BOW
	dw DOUBLE_TEAM, DIZZY_PUNCH, FLAMETHROWER, THUNDERPUNCH
	db 18
	dw CHINCHOU
	db MIRACLEBERRY
