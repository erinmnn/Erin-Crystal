...
Moves1:
	...
	move EFFECT_NORMAL_HIT,         75, FIGHTING,      100, 25,   0      ;KARATE_CHOP
	move EFFECT_MULTI_HIT,          18, NORMAL,        100, 10,   0      ;DOUBLESLAP
	move EFFECT_MULTI_HIT,          25, STEEL,         100, 15,   0      ;COMET_PUNCH
	move EFFECT_NORMAL_HIT,        120, NORMAL,         85, 20,   0      ;MEGA_PUNCH
	...
	move EFFECT_NORMAL_HIT,         60, NORMAL,        100, 30,   0      ;VICEGRIP
	...
	move EFFECT_ALWAYS_HIT,         60, FLYING,        100, 35,   0      ;WING_ATTACK
	move EFFECT_FORCE_SWITCH,        0, NORMAL,        100, 20,   0      ;WHIRLWIND
	move EFFECT_FLY,                95, FLYING,        100, 15,   0      ;FLY
	move EFFECT_TRAP_TARGET,        15, NORMAL,        100, 20,   0      ;BIND
	move EFFECT_NORMAL_HIT,         95, NORMAL,         85, 20,   0      ;SLAM
	move EFFECT_NORMAL_HIT,         40, GRASS,         100, 10,   0      ;VINE_WHIP
	move EFFECT_STOMP,              65, NORMAL,        100, 20,  30      ;STOMP
	move EFFECT_DOUBLE_HIT,         40, FIGHTING,      100, 30,   0      ;DOUBLE_KICK
	move EFFECT_NORMAL_HIT,        120, NORMAL,         85,  5,   0      ;MEGA_KICK
	...
	move EFFECT_MULTI_HIT,          15, NORMAL,        100, 20,   0      ;FURY_ATTACK
	...
	move EFFECT_TRAP_TARGET,        20, NORMAL,        100, 20,   0      ;WRAP
	move EFFECT_RECOIL_HIT,         90, NORMAL,        100, 20,   0      ;TAKE_DOWN
	...
	move EFFECT_SLEEP,               0, NORMAL,         70, 15,   0      ;SING
	move EFFECT_CONFUSE,             0, NORMAL,         60, 20,   0      ;SUPERSONIC
	move EFFECT_STATIC_DAMAGE,      20, NORMAL,        100, 20,   0      ;SONICBOOM
	move EFFECT_DISABLE,             0, NORMAL,        100, 20,   0      ;DISABLE
	move EFFECT_DEFENSE_DOWN_HIT,   40, POISON,        100, 20,  50      ;ACID
	...
	move EFFECT_HYPER_BEAM,        150, NORMAL,        100,  5,   0      ;HYPER_BEAM
	move EFFECT_NORMAL_HIT,         40, FLYING,        100, 35,   0      ;PECK
	move EFFECT_NORMAL_HIT,         80, FLYING,        100, 20,   0      ;DRILL_PECK
	move EFFECT_NORMAL_HIT,         80, FIGHTING,      100, 25,   0      ;SUBMISSION
	move EFFECT_SPEED_DOWN_HIT,     40, FIGHTING,      100, 20,  30      ;LOW_KICK
	...
	move EFFECT_ALWAYS_HIT,         60, GRASS,         100, 25,   0      ;RAZOR_LEAF
	...
	move EFFECT_SPEED_DOWN_2,        0, BUG,           100, 40,   0      ;STRING_SHOT
	move EFFECT_STATIC_DAMAGE,      40, DRAGON,        100, 10,   0      ;DRAGON_RAGE
	move EFFECT_TRAP_TARGET,        20, FIRE,          100, 15,   0      ;FIRE_SPIN
	...
	move EFFECT_NORMAL_HIT,         60, ROCK,          100, 15,   0      ;ROCK_THROW
	...
	move EFFECT_TOXIC,               0, POISON,        100, 10,   0      ;TOXIC
	...
	move EFFECT_NORMAL_HIT,        100, NORMAL,        100, 10,   0      ;EGG_BOMB
	move EFFECT_PARALYZE_HIT,       20, GHOST,         100, 30, 100      ;LICK
	move EFFECT_POISON_HIT,         20, POISON,        100, 20,  50      ;SMOG
	move EFFECT_POISON_HIT,        120, POISON,         70, 20,  30      ;SLUDGE
	move EFFECT_FLINCH_HIT,         85, GROUND,        100, 20,  10      ;BONE_CLUB
	move EFFECT_BURN_HIT,          120, FIRE,           85,  5,  10      ;FIRE_BLAST
	move EFFECT_FLINCH_HIT,         95, WATER,         100, 15,  10      ;WATERFALL
	move EFFECT_TRAP_TARGET,        35, WATER,         100, 10,   0      ;CLAMP
	move EFFECT_ALWAYS_HIT,         60, NORMAL,        100, 20,   0      ;SWIFT
	move EFFECT_SKULL_BASH,        150, NORMAL,        100, 15,   0      ;SKULL_BASH
	move EFFECT_MULTI_HIT,          25, NORMAL,        100, 15,   0      ;SPIKE_CANNON
	move EFFECT_SPEED_DOWN_HIT,     10, NORMAL,        100, 35, 100      ;CONSTRICT
	...
	move EFFECT_MULTI_HIT,          15, NORMAL,        100, 20,   0      ;BARRAGE
	move EFFECT_LEECH_HIT,          80, BUG,           100, 15,   0      ;LEECH_LIFE
	move EFFECT_SLEEP,               0, NORMAL,         85, 10,   0      ;LOVELY_KISS
	move EFFECT_RECOIL_HIT,        120, FLYING,        100,  5,   0      ;SKY_ATTACK
	move EFFECT_TRANSFORM,           0, NORMAL,        100, 10,   0      ;TRANSFORM
	move EFFECT_SPEED_DOWN_HIT,     20, WATER,         100, 30,  10      ;BUBBLE
	move EFFECT_CONFUSE_HIT,        70, NORMAL,        100, 10,  50      ;DIZZY_PUNCH
	...
	move EFFECT_SUPER_FANG,          1, NORMAL,        100, 10,   0      ;SUPER_FANG
	...
	move EFFECT_THIEF,              75, DARK,          100, 10, 100      ;THIEF
	...
	move EFFECT_SPEED_UP_HIT,       60, FIRE,          100, 25, 100      ;FLAME_WHEEL
	...
	move EFFECT_CONFUSE_HIT,       100, FLYING,        100,  5,  30      ;AEROBLAST
	...
	move EFFECT_PRIORITY_HIT,       40, ICE,           100, 25,  10      ;POWDER_SNOW
	...
	move EFFECT_ACCURACY_DOWN_HIT,  95, WATER,         100, 10,  50      ;OCTAZOOKA
	...
	move EFFECT_SPEED_DOWN_HIT,     55, ICE,           100, 15, 100      ;ICY_WIND
	move EFFECT_PROTECT,             0, FIGHTING,      100,  5,   0      ;DETECT
	move EFFECT_SPEED_DOWN_HIT,     60, GROUND,        100, 10,   0      ;BONE_RUSH
	...
	move EFFECT_SWAGGER,             0, NORMAL,        100, 15, 100      ;SWAGGER
	move EFFECT_HEAL,                0, NORMAL,        100, 10,   0      ;MILK_DRINK
	move EFFECT_ALWAYS_HIT,         60, ELECTRIC,      100, 20,  30      ;SPARK
	move EFFECT_NORMAL_HIT,         80, BUG,           100, 20,   0      ;FURY_CUTTER
	...
	move EFFECT_RAIN_DANCE,          0, WATER,         100,  5,   0      ;RAIN_DANCE
	move EFFECT_SUNNY_DAY,           0, FIRE,          100,  5,   0      ;SUNNY_DAY
	...
	move EFFECT_ALL_UP_HIT,         80, ROCK,          100,  5,  10      ;ANCIENTPOWER
	move EFFECT_DEFENSE_DOWN_HIT,   80, GHOST,         100, 15,  20      ;SHADOW_BALL
	move EFFECT_FUTURE_SIGHT,      100, PSYCHIC_TYPE,  100, 15,   0      ;FUTURE_SIGHT
	move EFFECT_DEFENSE_DOWN_HIT,   20, FIGHTING,      100, 15, 100      ;ROCK_SMASH
	move EFFECT_TRAP_TARGET,        40, WATER,         100, 15,   0      ;WHIRLPOOL
