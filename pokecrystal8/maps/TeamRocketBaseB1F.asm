...
TeamRocketBaseB1F_MapEvents:
	...
	object_event 17,  8, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerGruntM16, EVENT_BEAT_ROCKET_EXECUTIVEF_2
	object_event 24, 10, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerScientistJed, EVENT_BEAT_ROCKET_EXECUTIVEF_2
