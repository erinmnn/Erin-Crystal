...
Route19_MapEvents:
	...
	def_bg_events
	bg_event 15,  9, BGEVENT_READ, Route19Sign
	...
	object_event  3, 26, SPRITE_SWIMMER_GUY, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, TrainerSwimmermJerome, -1
