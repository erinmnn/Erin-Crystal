...
IndigoPlateauPokecenter1F_MapEvents:
	...
	def_coord_events
	coord_event  3,  2, SCENE_INDIGOPLATEAUPOKECENTER1F_RIVAL_BATTLE, PlateauRivalBattle1
	coord_event  4,  2, SCENE_INDIGOPLATEAUPOKECENTER1F_RIVAL_BATTLE, PlateauRivalBattle2
