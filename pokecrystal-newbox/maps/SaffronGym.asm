...
SaffronGym_MapEvents:
	...
	warp_event 15,  5, SAFFRON_GYM, 19
	warp_event  9,  5, SAFFRON_GYM, 20
	...
	warp_event  1, 17, SAFFRON_GYM, 28
	warp_event 15,  3, SAFFRON_GYM, 29
	warp_event 19,  9, SAFFRON_GYM, 30
	warp_event 19, 11, SAFFRON_GYM, 31
	warp_event 11,  9, SAFFRON_GYM, 32
	warp_event 19, 17, SAFFRON_GYM, 3
	warp_event  1, 15, SAFFRON_GYM, 4
	warp_event  9,  3, SAFFRON_GYM, 5
	...
	warp_event  1,  5, SAFFRON_GYM, 14
	warp_event 19, 15, SAFFRON_GYM, 15
	warp_event 15,  9, SAFFRON_GYM, 16
	warp_event 11,  3, SAFFRON_GYM, 17
	...
	object_event 17, 13, SPRITE_GRANNY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 4, TrainerMediumDoris, -1
	object_event  3,  1, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 4, TrainerPsychicFranklin, -1
	object_event  3, 13, SPRITE_GRANNY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 4, TrainerMediumRebecca, -1
	object_event 17,  1, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 4, TrainerPsychicJared, -1
