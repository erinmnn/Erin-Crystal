...
VermilionGym_MapEvents:
	...
	bg_event  7,  8, BGEVENT_READ, VermilionGymTrashCan
	bg_event  8,  8, BGEVENT_READ, VermilionGymTrashCan
	bg_event  9, 10, BGEVENT_READ, VermilionGymTrashCan
	bg_event  9,  7, BGEVENT_READ, VermilionGymTrashCan
	bg_event  1,  9, BGEVENT_READ, VermilionGymTrashCan
	bg_event  1,  8, BGEVENT_READ, VermilionGymTrashCan
	bg_event  9,  6, BGEVENT_READ, VermilionGymTrashCan
	bg_event  9,  8, BGEVENT_READ, VermilionGymTrashCan
	bg_event  9,  9, BGEVENT_READ, VermilionGymTrashCan
	bg_event  1, 11, BGEVENT_READ, VermilionGymTrashCan
	bg_event  1, 10, BGEVENT_READ, VermilionGymTrashCan
	bg_event  1,  6, BGEVENT_READ, VermilionGymTrashCan
	bg_event  0,  8, BGEVENT_READ, VermilionGymTrashCan
	bg_event  9, 11, BGEVENT_READ, VermilionGymTrashCan
	bg_event  1, 15, BGEVENT_READ, VermilionGymStatue
	bg_event  8, 15, BGEVENT_READ, VermilionGymStatue
	...
	object_event  6, 10, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 4, TrainerGentlemanGregory, -1
	...
	object_event  3, 14, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 4, TrainerJugglerHorton, -1
