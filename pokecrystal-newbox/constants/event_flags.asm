...
; Johto Gym Leader TM gifts
	const EVENT_GOT_TM18_WING_ATTACK
...
; Johto story events
	...
	const EVENT_REFUSED_TO_HELP_LANCE_AT_CIANWOOD
...
; Crystal-exclusive events in Johto
	...
	const EVENT_ROUTE_34_SNORLAX_GONE
	const EVENT_BEAT_AZALEA_RIVAL
	const EVENT_GOT_TWISTEDSPOON
	const EVENT_ARIANA_FLED
	const EVENT_TIN_TOWER_ROCKET_POPULATION
	const EVENT_TIN_TOWER_EMERGENCY
...
; Phone events
	...
	const EVENT_ROUTE10NORTH_ZAPDOS
...
; More Johto story events
	...
	const EVENT_CONTEST_OFFICER_HAS_BRIGHTPOWDER
...
; Johto itemballs
	...
	const EVENT_SLOWPOKE_WELL_B2F_TM_MUD_SLAP
...
; Johto people
	...
	const EVENT_CIANWOOD_LANCE
	const EVENT_CIANWOOD_LANCE_AND_DRAGONITE
...
; New to Crystal
	const EVENT_GOT_ROUTE_32_STARTER
