...
MapGroup_Blackthorn:
	...
	map Route45, TILESET_JOHTO, GATE, LANDMARK_ROUTE_45, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
...
MapGroup_Cianwood:
	...
	map BattleTowerElevator, TILESET_GATE, INDOOR, LANDMARK_BATTLE_TOWER, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
