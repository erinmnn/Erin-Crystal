...
CroconawEvosAttacks:
	dbbw EVOLVE_LEVEL, 32, FERALIGATR
	db 0 ; no more evolutions
	db 1, POUND
	db 1, LEER
	db 1, WATER_GUN
...
IgglybuffEvosAttacks:
	dbbw EVOLVE_LEVEL, 15, JIGGLYPUFF
	db 0 ; no more evolutions
	db 1, SING
	db 1, CHARM
	db 4, DEFENSE_CURL
