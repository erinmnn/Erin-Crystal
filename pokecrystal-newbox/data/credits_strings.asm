...
.AkitoMori:           db "    SABERGAMER57@"          ; "もり　あきと@"
...
.HiroshiYamauchi:     db "        ERIN@"              ; "やまうち　ひろし@"
...
.KunimiKawamura:      db "    BUDGETPERSON@"          ; "かわむら　くにみ@"
...
.GakuziNomoto:        db "        TEWU@"              ; "のもと　がくじ@"
.AiMashima:           db "      EMI BERYL@"           ; "ましま　あい@"
.MikihiroIshikawa:    db "    NVFLASHRUNNER@"         ; "いしかわ　みきひろ@"
.HideyukiHashimoto:   db "    SAVEASUNTITLED@"        ; "はしもと　ひでゆき@"
...
.KimikoNakamichi:     db "    SPACEYDONUT@"
.Staff:               db "      #MON"                 ; "ポケットモンスター"
                    next "  ERIN CRYSTAL"          ; "　　クりスタル　バージョン"
                    next "       STAFF@"              ; "　　　　スタッフ@"
